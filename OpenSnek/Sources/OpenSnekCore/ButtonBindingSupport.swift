...
public enum ButtonBindingSupport {
    ...
    private static func isBasiliskV3Family(_ profileID: DeviceProfileID?) -> Bool {
        ...
        case .basiliskV3XHyperspeed, .orochiV2, .nagaPro, .basilisk, .lanceheadTournamentEdition, .huntsmanMini, .tartarusPro, .krakenKittyV2, .none: return false
        }
    }
    ...
    public static func defaultDPIClutchDPI(for profileID: DeviceProfileID?) -> Int? {
        ...
        case .basiliskV3XHyperspeed, .orochiV2, .nagaPro, .basilisk, .lanceheadTournamentEdition, .huntsmanMini, .tartarusPro, .krakenKittyV2, .none: return nil
        }
    }
    ...
    public static func semanticDefaultButtonBinding(for slot: Int, profileID: DeviceProfileID? = nil) -> ButtonBindingDraft? {
        ...
        case 96:
            ...
            case .huntsmanMini, .tartarusPro, .krakenKittyV2: return nil
            }
        default: return nil
        }
    }
    ...
    private static func buttonSlotDescriptors(for profileID: DeviceProfileID?) -> [ButtonSlotDescriptor] {
        ...
        case .huntsmanMini, .tartarusPro, .krakenKittyV2: return []
        }
    }
